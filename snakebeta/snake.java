...
class myPanel extends JPanel
{
	...
	public myPanel()
	{
		...
		try
		{
			fon = ImageIO.read(new File("C:\\Users\\student\\Sandrovskiy\\snakebeta\\fon.png"));
			telo = ImageIO.read(new File("C:\\Users\\student\\Sandrovskiy\\snakebeta\\telo.png"));
			golova = ImageIO.read(new File("C:\\Users\\student\\Sandrovskiy\\snakebeta\\golova.png"));
			ob = ImageIO.read(new File("C:\\Users\\student\\Sandrovskiy\\snakebeta\\ob.png"));
			end = ImageIO.read(new File("C:\\Users\\student\\Sandrovskiy\\snakebeta\\end.png"));
		}
		catch(Exception ex) {}
		myGame = new game();
		myGame.start();
	...
	public void paintComponent(Graphics gr)
	{
		...
		if(myGame.end==true)
		{
			gr.drawImage(end, 250,200,200,100,null);
		}
	}
}
